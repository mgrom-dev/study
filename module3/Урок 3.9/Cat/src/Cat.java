...
public class Cat
{
    ...
    public String toString(){
        ...
        return String.format(color + getName() + " status: " + getStatus() + ", weight: %.0f \u001B[0m", weight);
    } //get a string representation of this object

    private void catSay(String text){
        if (isAlive(this)) System.out.println(text);
        else System.out.println(name + " is r.i.p...");
    }
    ...
    public void meow()
    {
        ...
        modWeight(- 1.0);
        catSay(this.name +" says: " + words[(int)(Math.random() * words.length)]);
    }
    ...
    public void goTray()
    {
        ...
        catSay(String.format(name + " pilled on %.2f kg", dumpWeight/1000));
    } //go to Toilet cat

    public void feed(double amount)
    {
        modWeight(amount);
        catSay(String.format(name + " eat on %.2f kg", amount/1000));
    }

    public void drink(double amount)
    {
        modWeight(amount);
        catSay(String.format(name + " drink on %.2f kg", amount/1000));
    }
